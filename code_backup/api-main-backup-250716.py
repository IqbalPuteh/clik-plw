...
async def get_company(
    ...
    for attempt in range(0, max_retries):
        ...
        try:
            ...
            logger.info(f"CALCULATE Company-Html TIMER START to END: {elapsed:.2f} seconds")            
...
async def get_individual(
    ...
    for attempt in range(0, max_retries):
        try:
            ...
            # Print CALCULATE TIMER START to END
            elapsed = timer_end - timer_start
            logger.info(f"CALCULATE Individual-Html TIMER START to END: {elapsed:.2f} seconds")
